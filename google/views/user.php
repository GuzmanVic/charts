  ...
  <!-- <p> Mostrar cantidad de <select name="sel" id="value"> 
    ...
    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#create">
      ...
      <i class="fa fa-power-off" aria-hidden="true"></i>
       ...
       <a href="grafica.php" class="btn btn-primary"><b>Grafica</b> </a>
...
$conexion=mysqli_connect("localhost","root","","r_user");               
$SQL=mysqli_query($conexion,"SELECT user.id, user.nombre, user.edad, user.correo, user.password, user.telefono,
...
<td><img src="../imgs/<?php echo $fila['imagen']; ?>" onerror=this.src="../imgs/noimage.png" width="50" 
heigth="70"></td>
