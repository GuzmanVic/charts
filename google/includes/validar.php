...
if (
    ...
    $sql = "INSERT INTO user (nombre, edad, correo, telefono, password, rol, imagen)
    VALUES (?, ?, ?, ?, ?,?, ?)";

    if ($statement = mysqli_prepare($conexion, $sql)) {

        mysqli_stmt_bind_param($statement, "sssssss", $nombre, $edad, $correo, $telefono, $password, $rol, $imagen);
